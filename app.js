...
var addButton=document.querySelector(".new-task__button");//new task button
var incompleteTaskHolder=document.querySelector(".section__list_incomplete");//ul of .section__list_incomplete
